...
export const GATEWAY_REGISTRY = {
  ...
  // UsePod, Venice, and OrcaRouter have no distinctive key/token prefix, so they can't be
  ...
  orcarouter: { label: 'OrcaRouter', secretName: 'ORCAROUTER_API_KEY', prefixes: [], domain: 'orcarouter.ai' },
